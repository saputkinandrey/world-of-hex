                            ...
                            <Metric
                                ...
                                value={
                                    summary.estimatedAverageBuildWeight
                                        ? `${formatNumber(summary.averageWeightLb ?? summary.estimatedAverageBuildWeight.weightLb.average, 2)} lb / SM${summary.estimatedAverageBuildWeight.sizeModifier}`
                                        : "disabled"
                                }
                            />
                        </Box>
                        ...
                        >
                            <Stack spacing={2}>
                                ...
                                summary.estimatedHexVolume ? (
                                    <Alert severity="info">
                                        Estimated average-build body weight from
                                        SM
                                        {
                                            summary.estimatedAverageBuildWeight
                                                .sizeModifier
