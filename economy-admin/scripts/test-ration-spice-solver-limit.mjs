...
if (!calculatorSource.includes('candidate.isLimited && candidate.quantity >= options.limitedItemMaxQuantity')) {
  throw new Error('Ration solver must skip limited candidates after they reach the cap.');
}
