...
import ModifierBucketJournals from '../_legacy/module/modifier-bucket/select-journals.js';
...
export const SETTING_PLAYER_CHAT_PRIVATE = 'user-connected-chat-private';
...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_AUTOMATICALLY_SET_IGNOREQTY, {
      ...
      default: false,
      onChange: (value) =>
        console.log(`Automatically set ignore QTY : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_IMPORT_HP_FP, {
      ...
      onChange: (value) =>
        console.log(`Import of Current HP and FP : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_CHECK_EQUIPPED, {
      ...
      default: false,
      onChange: (value) =>
        console.log(`Check 'Equipped' items in weight calculation : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SHOW_USER_CREATED, {
      ...
      default: true,
      onChange: (value) =>
        console.log(`Show a 'saved' icon for user created items : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SHOW_FOUNDRY_CREATED, {
      ...
      default: true,
      onChange: (value) =>
        console.log(`Show a 'star' icon for Foundry items : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_ignoreImportQty, {
      ...
      default: true,
      onChange: (value) =>
        console.log(`Show a 'star' icon for QTY/Count saved items : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_CONVERT_RANGED, {
      ...
      default: true,
      onChange: (value) =>
        console.log(`Mulitple ranged columns during import : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_RANGE_TO_BUCKET, {
      ...
      default: true,
      onChange: (value) =>
        console.log(`Automatically add range ruler mod to bucket : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_BUCKET_JOURNALS, {
      ...
      onChange: (value) =>
        console.log(
          `Updated Modifier Bucket Journals: ${JSON.stringify(value)}`,
        ),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SIMPLE_DAMAGE, {
      ...
      default: false,
      onChange: (value) =>
        console.log(`Use simple Apply Damage Dialog : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SHOW_THE_MATH, {
      ...
      default: true,
      onChange: (value) =>
        console.log(`Always expand SHOW THE MATH : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_AUTOMATIC_ONETHIRD, {
      ...
      default: false,
      onChange: (value) =>
        console.log(`Use automatic reeling/tired : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SHOW_CHAT_FOR_REELING_TIRED, {
      ...
      default: false,
      onChange: (value) =>
        console.log(`Display Reeling/Tired Status in Chat : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_MANEUVER_UPDATES_MOVE, {
      ...
      default: true,
      onChange: (value) =>
        console.log(`${SETTING_MANEUVER_UPDATES_MOVE}: ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SHIFT_CLICK_BLIND, {
      ...
      default: false,
      onChange: (value) =>
        console.log(`SHIFT Click does a Blind roll for players : ${value}`),
    });
    ...
    game.settings.register(SYSTEM_NAME, SETTING_PORTRAIT_PATH, {
      ...
      choices: {
        ...
        local:
          'Local ([Foundry User Data]/Data/worlds/[World]/images/portaits/)',
      },
