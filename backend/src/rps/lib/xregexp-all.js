  ...
  return (function () {
  ...
  })()(
    {
        ...
        function (require, module, exports) {
          ...
          var _default = function _default(XRegExp) {
            ...
            XRegExp.matchRecursive = function (
              ...
              var sticky =
                (0, _indexOf['default'])(flags).call(flags, 'y') !== -1; // Flag `y` is handled manually
                ...
                if (leftMatch) {
                  ...
                  if (unbalanced === 'skip' || unbalanced === 'skip-lazy') {
                    if (rightMatch) {
                      ...
                      if (unbalanced === 'skip') {
                        var outerStartDelimLength = XRegExp.exec(
                          str,
                          left,
                          outerStart,
                          'sticky',
                    ...
                    throw new Error(
                      'Unsupported value for unbalanced: '.concat(unbalanced),
                    );
                  }
      ...
      5: [
        function (require, module, exports) {
          ...
          var _properties = _interopRequireDefault(
            require('../../tools/output/properties'),
          );
      ...
      7: [
        function (require, module, exports) {
          ...
          var _unicodeProperties = _interopRequireDefault(
            require('./addons/unicode-properties'),
          );

          var _unicodeScripts = _interopRequireDefault(
            require('./addons/unicode-scripts'),
          );
      ...
      52: [
        ...
        {
          '../../internals/path': 136,
          '../../modules/es.object.define-property': 174,
        },
      ],
      53: [
        function (require, module, exports) {
      ...
      54: [
        ...
        {
          '../../internals/regexp-flags': 138,
          '../../modules/es.regexp.flags': 178,
        },
      ],
      55: [
        function (require, module, exports) {
...
*/
      ...
      127: [
        ...
        {
          '../internals/enum-bug-keys': 96,
          '../internals/object-keys-internal': 130,
        },
      ],
      128: [
        function (require, module, exports) {
