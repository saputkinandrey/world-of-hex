...
export default class ModifierBucketEditor extends Application {
  ...
  static get defaultOptions() {
    let scale = game.settings.get(
      Settings.SYSTEM_NAME,
      Settings.SETTING_BUCKET_SCALE,
    );
  ...
  get journals() {
    const settings =
      game.settings.get(
        Settings.SYSTEM_NAME,
        Settings.SETTING_BUCKET_JOURNALS,
      ) || [];
    let bucketPages = [];
  ...
  activateListeners(html) {
    ...
    html
      .find('.collapsible-content .content-inner .selectable')
      .click(this._onSelect.bind(this));
    html
      .find('.collapsible-wrapper > input')
      ...
      setTimeout(
        () =>
          ui.notifications.info(
            "Unable to determine modifier for '" + element.value + "'",
          ),
        200,
      );
...
const ModifierLiterals = {
  ...
  get SizeModifiers() {
    return [
      ...
      game.i18n.format('GURPS.modifierSizeEntry', {
        SM: '-10',
        us: '1.5 inches',
        metric: '5 cm',
      }),
      ...
      game.i18n.format('GURPS.modifierSizeEntry', {
        SM: ' +8',
        us: ' 50 yards/150 feet',
        metric: '50 meters',
      }),
      game.i18n.format('GURPS.modifierSizeEntry', {
        SM: ' +9',
        us: ' 70 yards/210 feet',
        metric: '70 meters',
      }),
      game.i18n.format('GURPS.modifierSizeEntry', {
        SM: '+10',
        us: '100 yards/300 feet',
        metric: '100 meters',
      }),
    ];
  },
      ...
      for (let loc in HitLocations.hitlocationRolls) {
        ...
        if (!hit.skip) {
          let parts = [
            ...
            i18n('GURPS.modifierToHit'),
            i18n('GURPS.hitLocation' + loc),
          ];
