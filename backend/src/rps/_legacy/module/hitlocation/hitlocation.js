...
export class HitLocation {
  ...
  static init() {
    ...
    hitlocationRolls = {
      ...
      Nose: {
        penalty: -7,
        desc: ['GURPS.hitLocationDescFront', 'GURPS.hitLocationDescChest'],
      },
      Jaw: {
        penalty: -6,
        desc: ['GURPS.hitLocationDescFront', 'GURPS.hitLocationDescChest'],
      ...
      'Chinks in Other': {
        penalty: -10,
        desc: ['GURPS.hitLocationDescHalfDR'],
      },
    };
    ...
    hitlocationDictionary = {
      ...
      'humanoid expanded': {
        ...humanoidHitLocations,
        ...{ Chest: { roll: '-', penalty: 0 } },
      }, // GCA
      'winged humanoid': {
        ...humanoidHitLocations,
        ...{ Wing: { roll: '-', penalty: -2, role: LIMB } },
      }, // GCA
   ...
   */
  static ready() {
    translations[i18n('GURPS.hitLocationArm, holding shield')] =
      'Arm, holding shield';
    ...
    translations[i18n('GURPS.hitLocationFace, from behind')] =
      'Face, from behind';
    ...
    translations[i18n('GURPS.hitLocationLeft Arm, holding shield')] =
    ...
    translations[i18n('GURPS.hitLocationLimb Vein/Artery')] =
      'Limb Vein/Artery';
    translations[i18n('GURPS.hitLocationMid Leg')] = 'Mid Leg';
    translations[i18n('GURPS.hitLocationNeck Vein/Artery')] =
      'Neck Vein/Artery';
    translations[i18n('GURPS.hitLocationNeck')] = 'Neck';
    translations[i18n('GURPS.hitLocationNose')] = 'Nose';
    translations[i18n('GURPS.hitLocationRight Arm, holding shield')] =
    ...
    translations[i18n('GURPS.hitLocationSkull, from behind')] =
      'Skull, from behind';
