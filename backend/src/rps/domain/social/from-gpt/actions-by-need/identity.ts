...
export const IdentityActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.06,
        costTime: 0.7,
        rewardSecondary: { IDENTITY: 0.65, COMMUNITY: 0.4, RESPECT: 0.3, TRADITION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.5,
        rewardSecondary: { IDENTITY: 0.55, STATUS: 0.3, CULTURE: 0.2, RESPECT: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { IDENTITY: 0.7, TRADITION: 0.6, CLARITY: 0.4, HONOR: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.06,
        rewardSecondary: { IDENTITY: 0.85, PURPOSE: 0.4, TRADITION: 0.4, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { IDENTITY: 0.7, CREATIVITY: 0.3 as any, STATUS: 0.2, CULTURE: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.4,
        risk: 0.08,
        rewardSecondary: { IDENTITY: 0.8, TRADITION: 0.5, RESILIENCE: 0.2, STATUS: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { IDENTITY: 0.8, MASTERY: 0.5, REPUTATION: 0.4, CULTURE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.12,
        rewardSecondary: { IDENTITY: 0.85, INTEGRITY: 0.5, PURPOSE: 0.5, HONOR: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { IDENTITY: 0.7, TRADITION: 0.5, MASTERY: 0.3, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 2.0,
        risk: 0.1,
        rewardSecondary: { IDENTITY: 0.9, PURPOSE: 0.5, CULTURE: 0.4, RESILIENCE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { IDENTITY: 0.8, COMMUNITY: 0.5, PURPOSE: 0.4, MORALE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { IDENTITY: 0.75, TRADITION: 0.5, CULTURE: 0.4, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.4,
        rewardSecondary: { IDENTITY: 0.8, CULTURE: 0.4, HONOR: 0.3, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.4,
        rewardSecondary: { IDENTITY: 0.85, STATUS: 0.5, REPUTATION: 0.4, MASTERY: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { IDENTITY: 0.7, CLARITY: 0.5, PURPOSE: 0.3, CULTURE: 0.2 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costTime: 0.6,
        risk: 0.08,
        rewardSecondary: { IDENTITY: 0.7, INTEGRITY: 0.5, RESPECT: 0.3, CLARITY: 0.4 },
