...
export const IntegrityActions: ActionDefinition[] = [
    {
        ...
        costTime: 1.0,
        risk: 0.15,
        rewardSecondary: { INTEGRITY: 0.8, JUSTICE: 0.6, TRUST: 0.5, CLARITY: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { INTEGRITY: 0.65, REPUTATION: 0.3, FAIRNESS: 0.3, CULTURE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        rewardSecondary: { INTEGRITY: 0.7, CLARITY: 0.6, ORDER: 0.4, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 0.8,
        risk: 0.08,
        rewardSecondary: { INTEGRITY: 0.75, CLARITY: 0.5, JUSTICE: 0.4, TRUST: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { INTEGRITY: 0.65, CLARITY: 0.5, TRUST: 0.3, ORDER: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.5,
        rewardSecondary: { INTEGRITY: 0.55, TRUST: 0.4, PRIVACY: 0.4, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        risk: 0.12,
        rewardSecondary: { INTEGRITY: 0.8, JUSTICE: 0.5, COURAGE: 0.3, TRUST: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.05,
        costTime: 0.6,
        rewardSecondary: { INTEGRITY: 0.6, RESPECT: 0.3, TRUST: 0.3, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { INTEGRITY: 0.65, FAIRNESS: 0.5, TRUST: 0.4, WEALTH: 0.1 },
    ...
    },
    {
        ...
        costTime: 0.9,
        risk: 0.08,
        rewardSecondary: { INTEGRITY: 0.7, FAIRNESS: 0.5, TRUST: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.7,
        rewardSecondary: { INTEGRITY: 0.7, RESPECT: 0.3, REPUTATION: 0.3, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.06,
        rewardSecondary: { INTEGRITY: 0.7, CLARITY: 0.6, STABILITY: 0.3, TRUST: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { INTEGRITY: 0.75, JUSTICE: 0.5, TRUST: 0.4, ORDER: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { INTEGRITY: 0.7, CLARITY: 0.5, DISCIPLINE: 0.4, ORDER: 0.3 },
