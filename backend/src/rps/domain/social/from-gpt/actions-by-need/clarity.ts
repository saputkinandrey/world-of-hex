...
export const ClarityActions: ActionDefinition[] = [
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { CLARITY: 0.7, ORDER: 0.5, PRODUCTIVITY: 0.3, FAIRNESS: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        rewardSecondary: { CLARITY: 0.65, ORDER: 0.5, TRUST: 0.3, INTEGRITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { CLARITY: 0.65, ORDER: 0.4, FOCUS: 0.3, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.4,
        rewardSecondary: { CLARITY: 0.7, KNOWLEDGE: 0.4, INTEGRITY: 0.2, ORDER: 0.3 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { CLARITY: 0.7, ORDER: 0.4, STABILITY: 0.3, SECURITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { CLARITY: 0.65, ORDER: 0.5, PRODUCTIVITY: 0.2, INTEGRITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { CLARITY: 0.7, FOCUS: 0.3, PRODUCTIVITY: 0.2, KNOWLEDGE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { CLARITY: 0.65, INTEGRITY: 0.4, TRUST: 0.3, ORDER: 0.3 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { CLARITY: 0.7, TRUST: 0.4, ORDER: 0.3, FAIRNESS: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        rewardSecondary: { CLARITY: 0.7, TRUST: 0.3, COMMUNITY: 0.2, PURPOSE: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        risk: 0.08,
        rewardSecondary: { CLARITY: 0.65, TRUST: 0.3, ORDER: 0.3, STABILITY: 0.3 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.4,
        rewardSecondary: { CLARITY: 0.75, PRODUCTIVITY: 0.3, QUALITY: 0.3, FOCUS: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { CLARITY: 0.7, PURPOSE: 0.3, MORALE: 0.3, ORDER: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        rewardSecondary: { CLARITY: 0.7, ORDER: 0.4, STABILITY: 0.3, TRUST: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { CLARITY: 0.75, SECURITY: 0.3, PURPOSE: 0.3, READINESS: 0.3 as any },
