...
export const TraditionActions: ActionDefinition[] = [
    {
        ...
        need: NeedTag.TRADITION,
        costEnergy: -0.12,
        costTime: 1.4,
        rewardSatisfaction: 0.7,
        rewardSecondary: { SPIRIT: 0.3, STABILITY: 0.3, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { COMMUNITY: 0.6, AFFECTION: 0.3, STATUS: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { KNOWLEDGE: 0.5, FAMILY: 0.3, COMMUNITY: 0.3 },
        socialImpact: {
            TRADITION: 0.55,
    ...
    },
    {
        ...
        rewardSecondary: { HYGIENE: 0.2, STATUS: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.8,
        rewardSatisfaction: 0.65,
        rewardSecondary: { SPIRIT: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { COMMUNITY: 0.5, FAMILY: 0.5, STATUS: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { STABILITY: 0.3, SPIRIT: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        rewardSatisfaction: 0.6,
        rewardSecondary: { KNOWLEDGE: 0.4, FAMILY: 0.3, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { CREATIVITY: 0.4, STATUS: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        rewardSatisfaction: 0.55,
        rewardSecondary: { STABILITY: 0.3, PURPOSE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        rewardSatisfaction: 0.65,
        rewardSecondary: { COMMUNITY: 0.4, RESPECT: 0.3, SECURITY: 0.1 },
    ...
    },
    {
        ...
        rewardSecondary: { COMMUNITY: 0.5, STATUS: 0.3, SPIRIT: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.25,
        costTime: 2.0,
        risk: 0.2, // риск неприятия/конфликта
        rewardSatisfaction: 0.7,
        rewardSecondary: {
            SPIRIT: 0.3,
            COMMUNITY: 0.3,
    ...
    },
    {
        ...
        costTime: 1.8,
        rewardSatisfaction: 0.75,
        rewardSecondary: { COMMUNITY: 0.5, LOYALTY: 0.3, STATUS: 0.2 },
    ...
    },
    {
        ...
        risk: 0.15,
        rewardSatisfaction: 0.55,
        rewardSecondary: { ORDER: 0.3 as any, RESPECT: 0.2 },
        socialImpact: {
            TRADITION: 0.5,
