...
export const LoveActions: ActionDefinition[] = [
    {
        ...
        rewardSecondary: { AFFECTION: 0.5, TRUST: 0.3, MOOD: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { AFFECTION: 0.6, IDENTITY: 0.2, FAMILY: 0.1 },
    ...
    },
    {
        ...
        rewardSecondary: { AFFECTION: 0.55, CULTURE: 0.2, INSPIRATION: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.8,
        risk: 0.1, // возможный конфликт
        rewardSatisfaction: 0.75,
        rewardSecondary: { TRUST: 0.4, SECURITY: 0.3, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.8,
        rewardSecondary: { AFFECTION: 0.5, PRODUCTIVITY: 0.3, EFFICIENCY: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { AFFECTION: 0.6, HEALTH: 0.4, FAMILY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { TRUST: 0.5, INTEGRITY: 0.3, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        risk: 0.18, // санкции за нарушение
        rewardSatisfaction: 0.95,
        rewardSecondary: { HONOR: 0.5, FAMILY: 0.4, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.4,
        rewardSatisfaction: 0.75,
        rewardSecondary: { ORDER: 0.3, PURPOSE: 0.3, WEALTH: 0.2 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costTime: 1.8,
        rewardSatisfaction: 0.8,
        rewardSecondary: { FAMILY: 0.5, COMMUNITY: 0.3, RESPECT: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.9,
        rewardSecondary: { AFFECTION: 0.5, SOCIAL: 0.3, MOOD: 0.5 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.7,
        rewardSecondary: { TRUST: 0.4, PRIVACY: 0.3, CLARITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.85,
        rewardSecondary: { MORALE: 0.4, RESILIENCE: 0.3, PURPOSE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        risk: 0.18, // спор/конфликт
        rewardSatisfaction: 0.8,
        rewardSecondary: { HONOR: 0.4, COURAGE: 0.3, NETWORK: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.9,
        rewardSecondary: { AFFECTION: 0.6, IDENTITY: 0.3, CULTURE: 0.2 },
    ...
    },
    {
        ...
        rewardSatisfaction: 0.85,
        rewardSecondary: { AFFECTION: 0.55, MOOD: 0.4, SOCIAL: 0.2 },
