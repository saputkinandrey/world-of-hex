...
export const FreedomActions: ActionDefinition[] = [
    {
        ...
        need: NeedTag.FREEDOM,
        costEnergy: -0.18,
        costTime: 1.6,
        risk: 0.15,
        rewardSatisfaction: 0.75,
        rewardSecondary: { CONTROL: 0.4, STATUS: 0.2, STABILITY: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { STABILITY: 0.2, PURPOSE: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { REST: 0.2, MASTERY: 0.1 },
    ...
    },
    {
        ...
        rewardSecondary: { CURIOSITY: 0.3, KNOWLEDGE: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { PURPOSE: 0.3, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 0.6,
        risk: 0.25, // риск санкций
        rewardSatisfaction: 0.65,
        rewardSecondary: { JUSTICE: 0.4, PURPOSE: 0.2 },
    ...
    },
    {
        ...
        risk: 0.22,
        rewardSatisfaction: 0.7,
        rewardSecondary: { WEALTH: 0.2, STATUS: 0.2, MASTERY: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { STABILITY: 0.3, STATUS: 0.1 },
    ...
    },
    {
        ...
        costTime: 0.9,
        rewardSatisfaction: 0.55,
        rewardSecondary: { SECURITY: 0.2, STABILITY: 0.2 },
    ...
    },
    {
        ...
        risk: 0.12,
        rewardSatisfaction: 0.55,
        rewardSecondary: { SECURITY: 0.25, CONTROL: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.6,
        rewardSecondary: { TRUST: 0.2, CONTROL: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.4,
        rewardSatisfaction: 0.6,
        rewardSecondary: { PRODUCTIVITY: 0.3, STABILITY: 0.2 },
    ...
    },
    {
        ...
        risk: 0.1,
        rewardSatisfaction: 0.65,
        rewardSecondary: { WEALTH: 0.3, STATUS: 0.1 },
        tradeEffect: {
    ...
    },
    {
        ...
        risk: 0.22,
        rewardSatisfaction: 0.8,
        rewardSecondary: { KNOWLEDGE: 0.4, WEALTH: 0.2 },
    ...
    },
    {
        ...
        risk: 0.1,
        rewardSatisfaction: 0.55,
        rewardSecondary: { JUSTICE: 0.25, STABILITY: 0.15 },
