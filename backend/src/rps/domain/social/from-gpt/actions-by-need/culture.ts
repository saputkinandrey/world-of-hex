...
export const CultureActions: ActionDefinition[] = [
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.4,
        rewardSecondary: { CULTURE: 0.75, IDENTITY: 0.5, TRADITION: 0.5, KNOWLEDGE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 2.0,
        rewardSecondary: { CULTURE: 0.85, STATUS: 0.4, NETWORK: 0.4, REPUTATION: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.8,
        risk: 0.1,
        rewardSecondary: { CULTURE: 0.9, IDENTITY: 0.6, HONOR: 0.4, TRADITION: 0.5 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { CULTURE: 0.75, JOY: 0.5 as any, COMMUNITY: 0.3, TRADITION: 0.4 },
        tradeEffect: {
            ribbons: '-N' as any,
            dye: -1 | (0 as any),
            candles: -1 | (0 as any),
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.6,
        rewardSecondary: { CULTURE: 0.8, COMMUNITY: 0.4, MORALE: 0.4, JOY: 0.4 as any },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.4,
        rewardSecondary: { CULTURE: 0.8, KNOWLEDGE: 0.4, IDENTITY: 0.3, JOY: 0.3 as any },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.8,
        rewardSecondary: { CULTURE: 0.8, IDENTITY: 0.5, RESPECT: 0.3, TRADITION: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.24,
        costTime: 2.2,
        rewardSecondary: { CULTURE: 0.95, COMMUNITY: 0.6, JOY: 0.6 as any, TRUST: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 2.0,
        rewardSecondary: { CULTURE: 0.85, STATUS: 0.4, REPUTATION: 0.3, INNOVATION_REP: 0.3 },
        requiresLocation: 'guild_hall|market',
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.4,
        rewardSecondary: { CULTURE: 0.7, CLARITY: 0.5, IDENTITY: 0.5, ORDER: 0.3 },
    ...
    },
    {
        ...
        costTime: 2.2,
        risk: 0.12,
        rewardSecondary: { CULTURE: 0.9, NETWORK: 0.5, KNOWLEDGE: 0.4, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.6,
        rewardSecondary: { CULTURE: 0.8, TRADITION: 0.6, IDENTITY: 0.5, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { CULTURE: 0.85, RESILIENCE: 0.4, COMMUNITY: 0.3, HONOR: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.8,
        rewardSecondary: { CULTURE: 0.85, STATUS: 0.4, TRUST: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.6,
        rewardSecondary: { CULTURE: 0.75, KNOWLEDGE: 0.5, IDENTITY: 0.3, ORDER: 0.3 },
