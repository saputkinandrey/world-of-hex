...
export const QualityActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { QUALITY: 0.65, CLARITY: 0.5, ORDER: 0.4, FAIRNESS: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.0,
        rewardSecondary: { QUALITY: 0.6, EFFICIENCY: 0.3, STABILITY: 0.2, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { QUALITY: 0.65, EFFICIENCY: 0.3, SAFETY: 0.2 as any, ORDER: 0.2 },
        tradeEffect: {
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.2,
        rewardSecondary: { QUALITY: 0.7, CLARITY: 0.4, EFFICIENCY: 0.3, INTEGRITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { QUALITY: 0.65, EFFICIENCY: 0.4, ORDER: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.8,
        rewardSecondary: { QUALITY: 0.7, INTEGRITY: 0.4, SAFETY: 0.2 as any, FAIRNESS: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.6,
        rewardSecondary: { QUALITY: 0.6, ORDER: 0.3, WEALTH: -0.2, EFFICIENCY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { QUALITY: 0.6, ORDER: 0.5, EFFICIENCY: 0.3, HYGIENE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { QUALITY: 0.75, INTEGRITY: 0.4, REPUTATION: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        rewardSecondary: { QUALITY: 0.6, CLARITY: 0.5, ORDER: 0.4, RESILIENCE: 0.2 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.4,
        rewardSecondary: { QUALITY: 0.8, CLARITY: 0.5, EFFICIENCY: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.6,
        rewardSecondary: { QUALITY: 0.75, MASTERY: 0.4, EFFICIENCY: 0.3, INTEGRITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 2.0,
        risk: 0.1,
        rewardSecondary: { QUALITY: 0.8, STABILITY: 0.4, WEALTH: 0.2, CONTROL: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { QUALITY: 0.75, CLARITY: 0.5, TRUST: 0.3, WEALTH: 0.2 },
