...
export const HonorActions: ActionDefinition[] = [
    ...
    },
    {
        ...
        costTime: 0.5,
        risk: 0.05,
        rewardSecondary: { HONOR: 0.7, INTEGRITY: 0.6, FAIRNESS: 0.5, DISCIPLINE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.15,
        rewardSecondary: { HONOR: 0.8, JUSTICE: 0.6, INTEGRITY: 0.4, COURAGE: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.6,
        risk: 0.35,
        rewardSecondary: { HONOR: 0.9, COURAGE: 0.6, REPUTATION: 0.4, FEAR: -0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.12,
        rewardSecondary: { HONOR: 0.8, INTEGRITY: 0.5, CLARITY: 0.4, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.2,
        rewardSecondary: { HONOR: 0.85, COURAGE: 0.5, JUSTICE: 0.4, SECURITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { HONOR: 0.7, DISCIPLINE: 0.5, ORDER: 0.4, TRUST: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { HONOR: 0.65, TRUST: 0.4, ORDER: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 0.5,
        risk: 0.12,
        rewardSecondary: { HONOR: 0.75, INTEGRITY: 0.6, JUSTICE: 0.3, COURAGE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { HONOR: 0.6, IDENTITY: 0.4, CLARITY: 0.4, DISCIPLINE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.1,
        rewardSecondary: { HONOR: 0.75, JUSTICE: 0.5, COMMUNITY: 0.3, ORDER: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { HONOR: 0.7, FAIRNESS: 0.5, COMMUNITY: 0.3, NETWORK: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        risk: 0.2,
        rewardSecondary: { HONOR: 0.8, INTEGRITY: 0.6, ORDER: 0.4, CLARITY: 0.3 },
        socialImpact: { TRUST: 0.3, RESENTMENT: -0.1 },
    ...
    },
    {
        ...
        costTime: 1.6,
        risk: 0.15,
        rewardSecondary: { HONOR: 0.85, FAIRNESS: 0.6, JUSTICE: 0.5, STABILITY: 0.4 },
