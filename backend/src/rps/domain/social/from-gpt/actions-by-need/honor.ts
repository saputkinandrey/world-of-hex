...
export const HonorActions: ActionDefinition[] = [
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.5,
        risk: 0.05, // упущенная выгода
        rewardSatisfaction: 0.7,
        rewardSecondary: { INTEGRITY: 0.6, FAIRNESS: 0.5, DISCIPLINE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        risk: 0.15, // месть злоумышленников
        rewardSatisfaction: 0.8,
        rewardSecondary: { JUSTICE: 0.6, INTEGRITY: 0.4, COURAGE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.22,
        costTime: 1.6,
        risk: 0.35, // ранение/смерть
        rewardSatisfaction: 0.9,
        rewardSecondary: { COURAGE: 0.6, REPUTATION: 0.4, FEAR: -0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        risk: 0.12, // урон самолюбию
        rewardSatisfaction: 0.8,
        rewardSecondary: { INTEGRITY: 0.5, CLARITY: 0.4, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { COURAGE: 0.5, JUSTICE: 0.4, SECURITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.7,
        rewardSecondary: { DISCIPLINE: 0.5, ORDER: 0.4, TRUST: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { TRUST: 0.4, ORDER: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.5,
        risk: 0.12, // нажить врага
        rewardSatisfaction: 0.75,
        rewardSecondary: { INTEGRITY: 0.6, JUSTICE: 0.3, COURAGE: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        rewardSatisfaction: 0.6,
        rewardSecondary: { IDENTITY: 0.4, CLARITY: 0.4, DISCIPLINE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        rewardSatisfaction: 0.8,
        rewardSecondary: { FAIRNESS: 0.5, TRUST: 0.4, ORDER: 0.3 },
    ...
    },
    {
        ...
        risk: 0.1,
        rewardSatisfaction: 0.75,
        rewardSecondary: { JUSTICE: 0.5, COMMUNITY: 0.3, ORDER: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.6,
        rewardSatisfaction: 0.7,
        rewardSecondary: { FAIRNESS: 0.5, COMMUNITY: 0.3, NETWORK: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 0.8,
        risk: 0.2, // штраф/лишения
        rewardSatisfaction: 0.8,
        rewardSecondary: { INTEGRITY: 0.6, ORDER: 0.4, CLARITY: 0.3 },
        socialImpact: { TRUST: 0.3, RESENTMENT: -0.1 },
    ...
    },
    {
        ...
        risk: 0.15,
        rewardSatisfaction: 0.85,
        rewardSecondary: { FAIRNESS: 0.6, JUSTICE: 0.5, STABILITY: 0.4 },
