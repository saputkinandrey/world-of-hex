...
export const StressActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.02,
        costTime: 0.25,
        rewardSecondary: { STRESS: 0.5, RESILIENCE: 0.3, FOCUS: 0.2, CLARITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { STRESS: 0.65, HEALTH: 0.2, RESILIENCE: 0.3, PRIVACY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.4,
        rewardSecondary: { STRESS: 0.6, HEALTH: 0.2, MORALE: 0.2, PRIVACY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.05,
        costTime: 0.5,
        rewardSecondary: { STRESS: 0.55, HEALTH: 0.3, RESILIENCE: 0.2, FOCUS: 0.1 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { STRESS: 0.65, CLARITY: 0.4, PRIVACY: 0.3, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.6,
        rewardSecondary: { STRESS: 0.7, HEALTH: 0.2, RESILIENCE: 0.3, MORALE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.02,
        costTime: 0.4,
        rewardSecondary: { STRESS: 0.55, PRODUCTIVITY: 0.2, FOCUS: 0.2, MORALE: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.3,
        risk: 0.06,
        rewardSecondary: { STRESS: 0.65, PRIVACY: 0.3, CONTROL: 0.3 as any, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.7,
        rewardSecondary: { STRESS: 0.7, COMMUNITY: 0.3, TRUST: 0.3, RESILIENCE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.6,
        rewardSecondary: { STRESS: 0.65, HEALTH: 0.1, JOY: 0.3 as any, MORALE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.6,
        rewardSecondary: { STRESS: 0.6, ORDER: 0.4, CONTROL: 0.2 as any, PRODUCTIVITY: 0.1 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.5,
        rewardSecondary: { STRESS: 0.6, HEALTH: 0.2, RESILIENCE: 0.2, MOOD: 0.2 as any },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.8,
        rewardSecondary: { STRESS: 0.75, HEALTH: 0.3, RESILIENCE: 0.3, MORALE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.4,
        rewardSecondary: { STRESS: 0.55, HEALTH: 0.1, JOY: 0.2 as any, CLARITY: 0.1 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.7,
        rewardSecondary: { STRESS: 0.7, STABILITY: 0.3, PRIVACY: 0.2, RESILIENCE: 0.3 },
