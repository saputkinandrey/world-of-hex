...
export const SpiritActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.04,
        costTime: 0.6,
        rewardSecondary: { SPIRIT: 0.55, REST: 0.1, PURPOSE: 0.2, STABILITY: 0.1 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { SPIRIT: 0.6, COMMUNITY: 0.3, REPUTATION: 0.2, TRADITION: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 1.2,
        rewardSecondary: { SPIRIT: 0.55, KNOWLEDGE: 0.2, TRADITION: 0.2, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.08,
        rewardSecondary: { SPIRIT: 0.7, DISCIPLINE: 0.5 as any, PURPOSE: 0.2, HEALTH: 0.05 },
    ...
    },
    {
        ...
        costTime: 2.5,
        risk: 0.18,
        rewardSecondary: { SPIRIT: 0.85, PURPOSE: 0.4, COMMUNITY: 0.2, KNOWLEDGE: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.9,
        risk: 0.15,
        rewardSecondary: { SPIRIT: 0.75, PURPOSE: 0.5, STABILITY: 0.3, JUSTICE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.22,
        costTime: 2.2,
        rewardSecondary: { SPIRIT: 0.85, FAMILY: 0.5, COMMUNITY: 0.4, TRADITION: 0.5 },
    ...
    },
    {
        ...
        costTime: 2.0,
        risk: 0.25,
        rewardSecondary: { SPIRIT: 0.8, SECURITY: 0.4, HEALTH: 0.2, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.25,
        costTime: 2.5,
        rewardSecondary: { SPIRIT: 0.9, COMMUNITY: 0.6, TRADITION: 0.6, JOY: 0.5 as any },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.8,
        rewardSecondary: { SPIRIT: 0.7, COMMUNITY: 0.4, HYGIENE: 0.2, PURPOSE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.4,
        costTime: 3.5,
        rewardSecondary: { SPIRIT: 1.0, TRADITION: 0.6, COMMUNITY: 0.5, STABILITY: 0.4 },
