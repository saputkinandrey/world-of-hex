...
export const PrivacyActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.18,
        costTime: 1.8,
        rewardSecondary: { PRIVACY: 0.85, STABILITY: 0.4, SECURITY: 0.3, CONTROL: 0.3 as any },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { PRIVACY: 0.7, CONTROL: 0.3 as any, STABILITY: 0.3, CLARITY: 0.2 },
        tradeEffect: {
            screens: -1,
            rope: -1 | (0 as any),
            stakes: '-N' as any,
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { PRIVACY: 0.7, SECURITY: 0.4, TRUST: 0.2, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { PRIVACY: 0.6, CLARITY: 0.3, STABILITY: 0.3, TRUST: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        rewardSecondary: { PRIVACY: 0.7, TRUST: 0.4, INTEGRITY: 0.3, CLARITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { PRIVACY: 0.65, INTEGRITY: 0.4, TRUST: 0.3, ORDER: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        risk: 0.06,
        rewardSecondary: { PRIVACY: 0.7, TRUST: 0.4, RESILIENCE: 0.2, CLARITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.5,
        rewardSecondary: { PRIVACY: 0.6, STABILITY: 0.3, CONTROL: 0.3 as any, FOCUS: 0.2 },
        socialImpact: { RESPECT: 0.2, CONFLICT: -0.05 as any },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { PRIVACY: 0.65, TRUST: 0.3, SECURITY: 0.2, FAIRNESS: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { PRIVACY: 0.65, STABILITY: 0.3, CONTROL: 0.2 as any, HEALTH: 0.1 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        rewardSecondary: { PRIVACY: 0.65, SECURITY: 0.3, CLARITY: 0.3, TRUST: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        rewardSecondary: { PRIVACY: 0.7, TRUST: 0.4, INTEGRITY: 0.3, STABILITY: 0.2 },
        tradeEffect: {
            wax: -1,
            ribbon: -1 | (0 as any),
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.7,
        rewardSecondary: { PRIVACY: 0.7, RESPECT: 0.3, HEALTH: 0.2, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.06,
        rewardSecondary: { PRIVACY: 0.7, CONTROL: 0.3 as any, SECURITY: 0.2, CLARITY: 0.2 },
