...
export const FaithActions: ActionDefinition[] = [
    {
        ...
        rewardSecondary: { SPIRIT: 0.3, FOCUS: 0.2, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { MOOD: 0.25, HOPE: 0.3 as any, TRADITION: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { COMMUNITY: 0.3, CULTURE: 0.2, CLARITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        risk: 0.12, // социальная уязвимость
        rewardSatisfaction: 0.7,
        rewardSecondary: { INTEGRITY: 0.5, CLARITY: 0.3, REST: 0.1 },
    ...
    },
    {
        ...
        rewardSecondary: { PURPOSE: 0.4, DISCIPLINE: 0.3, STABILITY: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { HONOR: 0.5, REPUTATION: 0.3, ORDER: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.6,
        rewardSatisfaction: 0.6,
        rewardSecondary: { COMMUNITY: 0.3, FAIRNESS: 0.2, JUSTICE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.7,
        rewardSecondary: { CULTURE: 0.3, TRADITION: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { KNOWLEDGE: 0.4, CLARITY: 0.4, INTEGRITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.65,
        rewardSecondary: { CLARITY: 0.5, STABILITY: 0.3, COURAGE: 0.2 },
    ...
    },
    {
        ...
        risk: 0.08,
        rewardSatisfaction: 0.7,
        rewardSecondary: { DISCIPLINE: 0.5, PURPOSE: 0.2, HEALTH: 0.05 },
    ...
    },
    {
        ...
        rewardSecondary: { COMMUNITY: 0.5, CULTURE: 0.4, MORALE: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.75,
        rewardSecondary: { SECURITY: 0.3, ORDER: 0.2, STABILITY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { COMMUNITY: 0.5, RESILIENCE: 0.4, HOPE: 0.4 as any },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        risk: 0.12, // могут не поверить
        rewardSatisfaction: 0.75,
        rewardSecondary: { COURAGE: 0.3, NETWORK: 0.2, CULTURE: 0.2 },
    ...
    },
    {
        ...
        risk: 0.18,
        rewardSatisfaction: 0.9,
        rewardSecondary: { PURPOSE: 0.4, STABILITY: 0.3, COURAGE: 0.3 },
