...
export const FaithActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.04,
        costTime: 0.6,
        rewardSecondary: { FAITH: 0.55, SPIRIT: 0.3, FOCUS: 0.2, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.05,
        costTime: 0.5,
        rewardSecondary: { FAITH: 0.5, MOOD: 0.25, HOPE: 0.3 as any, TRADITION: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 1.2,
        rewardSecondary: { FAITH: 0.6, COMMUNITY: 0.3, CULTURE: 0.2, CLARITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        risk: 0.12,
        rewardSecondary: { FAITH: 0.7, INTEGRITY: 0.5, CLARITY: 0.3, REST: 0.1 },
    ...
    },
    {
        ...
        costTime: 0.9,
        risk: 0.15,
        rewardSecondary: { FAITH: 0.75, PURPOSE: 0.4, DISCIPLINE: 0.3, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { FAITH: 0.9, HONOR: 0.5, REPUTATION: 0.3, ORDER: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { FAITH: 0.6, COMMUNITY: 0.3, FAIRNESS: 0.2, JUSTICE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.6,
        rewardSecondary: { FAITH: 0.7, CULTURE: 0.3, TRADITION: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.6,
        rewardSecondary: { FAITH: 0.65, KNOWLEDGE: 0.4, CLARITY: 0.4, INTEGRITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { FAITH: 0.65, CLARITY: 0.5, STABILITY: 0.3, COURAGE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.08,
        rewardSecondary: { FAITH: 0.7, DISCIPLINE: 0.5, PURPOSE: 0.2, HEALTH: 0.05 },
    ...
    },
    {
        ...
        costEnergy: -0.22,
        costTime: 1.8,
        rewardSecondary: { FAITH: 0.85, COMMUNITY: 0.5, CULTURE: 0.4, MORALE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { FAITH: 0.75, SECURITY: 0.3, ORDER: 0.2, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { FAITH: 0.8, COMMUNITY: 0.5, RESILIENCE: 0.4, HOPE: 0.4 as any },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.12,
        rewardSecondary: { FAITH: 0.75, COURAGE: 0.3, NETWORK: 0.2, CULTURE: 0.2 },
    ...
    },
    {
        ...
        costTime: 2.4,
        risk: 0.18,
        rewardSecondary: { FAITH: 0.9, PURPOSE: 0.4, STABILITY: 0.3, COURAGE: 0.3 },
