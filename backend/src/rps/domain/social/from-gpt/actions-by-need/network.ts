...
export const NetworkActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        rewardSecondary: { NETWORK: 0.65, COMMUNITY: 0.4, TRUST: 0.3, REPUTATION: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.7,
        rewardSecondary: { NETWORK: 0.6, TRUST: 0.4, CLARITY: 0.3, REPUTATION: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.08,
        rewardSecondary: { NETWORK: 0.75, COMMUNITY: 0.4, TRUST: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        rewardSecondary: { NETWORK: 0.7, FAIRNESS: 0.3, TRUST: 0.3, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { NETWORK: 0.6, COMMUNITY: 0.4, CULTURE: 0.2, REPUTATION: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { NETWORK: 0.75, TRUST: 0.3, WEALTH: 0.2, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        risk: 0.16,
        rewardSecondary: { NETWORK: 0.8, TRUST: 0.4, REPUTATION: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.4,
        rewardSecondary: { NETWORK: 0.8, COMMUNITY: 0.5, STABILITY: 0.4, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { NETWORK: 0.75, KNOWLEDGE: 0.4, REPUTATION: 0.3, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.08,
        rewardSecondary: { NETWORK: 0.8, STATUS: 0.4, TRUST: 0.3, REPUTATION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { NETWORK: 0.65, CLARITY: 0.3, COMMUNITY: 0.2, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.24,
        costTime: 2.2,
        rewardSecondary: { NETWORK: 0.9, COMMUNITY: 0.6, TRUST: 0.4, CULTURE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { NETWORK: 0.75, TRUST: 0.4, STABILITY: 0.3, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.4,
        rewardSecondary: { NETWORK: 0.8, KNOWLEDGE: 0.5, COMMUNITY: 0.4, REPUTATION: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.12,
        rewardSecondary: { NETWORK: 0.8, TRUST: 0.5, STABILITY: 0.4, COURAGE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { NETWORK: 0.75, CLARITY: 0.5, WEALTH: 0.3, STABILITY: 0.3 },
