...
export const FairnessActions: ActionDefinition[] = [
    {
        ...
        need: NeedTag.FAIRNESS,
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSatisfaction: 0.65,
        rewardSecondary: { CLARITY: 0.6, TRUST: 0.4, STABILITY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { TRUST: 0.4, ORDER: 0.3, WEALTH: 0.1 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        risk: 0.06, // раздражение проверяемых
        rewardSatisfaction: 0.65,
        rewardSecondary: { JUSTICE: 0.4, TRUST: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { TRUST: 0.4, ORDER: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { TRUST: 0.4, MORALE: 0.5, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.6,
        risk: 0.12, // оспаривание решения
        rewardSatisfaction: 0.8,
        rewardSecondary: { JUSTICE: 0.5, TRUST: 0.4, STABILITY: 0.4 },
    ...
    },
    {
        ...
        costTime: 0.6,
        rewardSatisfaction: 0.6,
        rewardSecondary: { CLARITY: 0.4, TRUST: 0.3, ORDER: 0.3 },
        requiresItem: ['lottery_bag|dice'],
    ...
    },
    {
        ...
        costTime: 0.8,
        rewardSatisfaction: 0.65,
        rewardSecondary: { TRUST: 0.3, ORDER: 0.3, COMMUNITY: 0.2 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        risk: 0.08,
        rewardSatisfaction: 0.7,
        rewardSecondary: { JUSTICE: 0.4, ORDER: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.2,
        rewardSatisfaction: 0.7,
        rewardSecondary: { STABILITY: 0.4, TRUST: 0.3, ORDER: 0.4 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.65,
        rewardSecondary: { CLARITY: 0.5, TRUST: 0.3, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        rewardSatisfaction: 0.7,
        rewardSecondary: { TRUST: 0.4, SECURITY: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        risk: 0.12, // сторона может спорить сумму
        rewardSatisfaction: 0.8,
        rewardSecondary: { JUSTICE: 0.5, STABILITY: 0.3, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        rewardSatisfaction: 0.65,
        rewardSecondary: { JUSTICE: 0.4, STABILITY: 0.3, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.7,
        rewardSecondary: { TRUST: 0.3, MORALE: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        risk: 0.12, // конфликт с влиятельным
        rewardSatisfaction: 0.75,
        rewardSecondary: { JUSTICE: 0.5, TRUST: 0.3, ORDER: 0.3 },
