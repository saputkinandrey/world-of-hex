...
export const FairnessActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { FAIRNESS: 0.65, CLARITY: 0.6, TRUST: 0.4, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.06,
        rewardSecondary: { FAIRNESS: 0.65, JUSTICE: 0.4, TRUST: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { FAIRNESS: 0.8, TRUST: 0.4, MORALE: 0.5, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.6,
        risk: 0.12,
        rewardSecondary: { FAIRNESS: 0.8, JUSTICE: 0.5, TRUST: 0.4, STABILITY: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { FAIRNESS: 0.6, CLARITY: 0.4, TRUST: 0.3, ORDER: 0.3 },
        requiresItem: ['lottery_bag|dice'],
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { FAIRNESS: 0.65, TRUST: 0.3, ORDER: 0.3, COMMUNITY: 0.2 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costTime: 0.9,
        risk: 0.08,
        rewardSecondary: { FAIRNESS: 0.7, JUSTICE: 0.4, ORDER: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { FAIRNESS: 0.7, STABILITY: 0.4, TRUST: 0.3, ORDER: 0.4 },
        tradeEffect: { parchment: -1, ink: -1 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { FAIRNESS: 0.65, CLARITY: 0.5, TRUST: 0.3, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { FAIRNESS: 0.7, TRUST: 0.4, SECURITY: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.12,
        rewardSecondary: { FAIRNESS: 0.8, JUSTICE: 0.5, STABILITY: 0.3, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { FAIRNESS: 0.65, JUSTICE: 0.4, STABILITY: 0.3, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 0.9,
        risk: 0.12,
        rewardSecondary: { FAIRNESS: 0.75, JUSTICE: 0.5, TRUST: 0.3, ORDER: 0.3 },
