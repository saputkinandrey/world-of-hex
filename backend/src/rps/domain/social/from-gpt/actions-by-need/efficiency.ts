...
export const EfficiencyActions: ActionDefinition[] = [
    {
        ...
        need: NeedTag.EFFICIENCY,
        costEnergy: -0.14,
        costTime: 1.4,
        rewardSatisfaction: 0.7,
        rewardSecondary: { CLARITY: 0.5, ORDER: 0.4, PRODUCTIVITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        risk: 0.06, // раздражение наблюдаемого
        rewardSatisfaction: 0.65,
        rewardSecondary: { CLARITY: 0.5, QUALITY: 0.2, PRODUCTIVITY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { ORDER: 0.6, QUALITY: 0.3, STABILITY: 0.3 },
        tradeEffect: {
            bins: '-N' as any,
            rags: '-wear',
            soap: -1 | (0 as any),
    ...
    },
    {
        ...
        costTime: 1.2,
        rewardSatisfaction: 0.7,
        rewardSecondary: { PRODUCTIVITY: 0.45, ORDER: 0.35, HEALTH: 0.15 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.7,
        rewardSecondary: { ORDER: 0.5, PRODUCTIVITY: 0.4, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.4,
        rewardSatisfaction: 0.75,
        rewardSecondary: { PRODUCTIVITY: 0.5, STABILITY: 0.3, QUALITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.65,
        rewardSecondary: { ORDER: 0.5, STABILITY: 0.3, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.75,
        rewardSecondary: { PRODUCTIVITY: 0.5, ORDER: 0.4, STABILITY: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { CLARITY: 0.4, PRODUCTIVITY: 0.3, DISCIPLINE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.2,
        risk: 0.08, // споры о справедливости
        rewardSatisfaction: 0.7,
        rewardSecondary: { PRODUCTIVITY: 0.4, FAIRNESS: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.7,
        rewardSecondary: { QUALITY: 0.4, ORDER: 0.3, PRODUCTIVITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.75,
        rewardSecondary: { STABILITY: 0.5, PRODUCTIVITY: 0.3, RESILIENCE: 0.3 },
        tradeEffect: {
            oil: -1,
            grease: -1 | (0 as any),
    ...
    },
    {
        ...
        costTime: 1.4,
        rewardSatisfaction: 0.7,
        rewardSecondary: { CLARITY: 0.5, PRODUCTIVITY: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.65,
        rewardSecondary: { HEALTH: 0.2, QUALITY: 0.2, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.75,
        rewardSecondary: { PRODUCTIVITY: 0.4, WEALTH: 0.2, RESILIENCE: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.7,
        rewardSecondary: { STABILITY: 0.5, ORDER: 0.4, PRODUCTIVITY: 0.3 },
