...
export const EfficiencyActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.14,
        costTime: 1.4,
        rewardSecondary: { EFFICIENCY: 0.7, CLARITY: 0.5, ORDER: 0.4, PRODUCTIVITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.06,
        rewardSecondary: { EFFICIENCY: 0.65, CLARITY: 0.5, QUALITY: 0.2, PRODUCTIVITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.8,
        rewardSecondary: { EFFICIENCY: 0.75, ORDER: 0.6, QUALITY: 0.3, STABILITY: 0.3 },
        tradeEffect: {
            bins: '-N' as any,
            rags: '-wear',
            soap: -1 | (0 as any),
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.2,
        rewardSecondary: { EFFICIENCY: 0.7, PRODUCTIVITY: 0.45, ORDER: 0.35, HEALTH: 0.15 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { EFFICIENCY: 0.7, ORDER: 0.5, PRODUCTIVITY: 0.4, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.4,
        rewardSecondary: { EFFICIENCY: 0.75, PRODUCTIVITY: 0.5, STABILITY: 0.3, QUALITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.0,
        rewardSecondary: { EFFICIENCY: 0.65, ORDER: 0.5, STABILITY: 0.3, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { EFFICIENCY: 0.75, PRODUCTIVITY: 0.5, ORDER: 0.4, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { EFFICIENCY: 0.6, CLARITY: 0.4, PRODUCTIVITY: 0.3, DISCIPLINE: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.08,
        rewardSecondary: { EFFICIENCY: 0.7, PRODUCTIVITY: 0.4, FAIRNESS: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.0,
        rewardSecondary: { EFFICIENCY: 0.7, QUALITY: 0.4, ORDER: 0.3, PRODUCTIVITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { EFFICIENCY: 0.75, STABILITY: 0.5, PRODUCTIVITY: 0.3, RESILIENCE: 0.3 },
        tradeEffect: {
            oil: -1,
            grease: -1 | (0 as any),
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.4,
        rewardSecondary: { EFFICIENCY: 0.7, CLARITY: 0.5, PRODUCTIVITY: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { EFFICIENCY: 0.65, HEALTH: 0.2, QUALITY: 0.2, PRODUCTIVITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.6,
        rewardSecondary: { EFFICIENCY: 0.75, PRODUCTIVITY: 0.4, WEALTH: 0.2, RESILIENCE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.0,
        rewardSecondary: { EFFICIENCY: 0.7, STABILITY: 0.5, ORDER: 0.4, PRODUCTIVITY: 0.3 },
