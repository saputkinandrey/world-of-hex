...
export const FearActions: ActionDefinition[] = [
    {
        ...
        rewardSecondary: { SECURITY: 0.4, STABILITY: 0.2, MOOD: 0.15 },
    ...
    },
    {
        ...
        rewardSecondary: { COURAGE: 0.4, DISCIPLINE: 0.4, READINESS: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        risk: 0.08, // могут не поверить
        rewardSatisfaction: 0.6,
        rewardSecondary: { STABILITY: 0.3, CLARITY: 0.3, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        rewardSecondary: { SECURITY: 0.4, COMMUNITY: 0.3, HONOR: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.7,
        rewardSecondary: { CONTROL: 0.3, ORDER: 0.3, READINESS: 0.4 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.6,
        rewardSecondary: { SPIRIT: 0.2, STABILITY: 0.2, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        risk: 0.12,
        rewardSatisfaction: 0.75,
        rewardSecondary: { SECURITY: 0.4, CONTROL: 0.3, READINESS: 0.4 },
    ...
    },
    {
        ...
        rewardSecondary: { SECURITY: 0.5, READINESS: 0.5, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.4,
        rewardSatisfaction: 0.7,
        rewardSecondary: { SECURITY: 0.5, ORDER: 0.2, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.75,
        rewardSecondary: { READINESS: 0.6, ORDER: 0.4, RESILIENCE: 0.3 },
    ...
    },
    {
        ...
        rewardSecondary: { RESILIENCE: 0.4, CLARITY: 0.3, MOOD: 0.2 },
    ...
    },
    {
        ...
        costTime: 0.8,
        rewardSatisfaction: 0.6,
        rewardSecondary: { CLARITY: 0.4, READINESS: 0.4, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        rewardSatisfaction: 0.7,
        rewardSecondary: { KNOWLEDGE: 0.4, COURAGE: 0.3, READINESS: 0.3 },
    ...
    },
    {
        ...
        costTime: 0.8,
        rewardSatisfaction: 0.65,
        rewardSecondary: { ORDER: 0.5, STABILITY: 0.5, SECURITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.6,
        rewardSecondary: { SPIRIT: 0.3, COMMUNITY: 0.2, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        risk: 0.1,
        rewardSatisfaction: 0.8,
        rewardSecondary: { SPIRIT: 0.4, STABILITY: 0.3, SECURITY: 0.3 },
