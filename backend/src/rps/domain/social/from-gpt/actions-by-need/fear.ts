...
export const FearActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { FEAR: 0.55, SECURITY: 0.4, STABILITY: 0.2, MOOD: 0.15 },
    ...
    },
    {
        ...
        costTime: 1.4,
        risk: 0.06,
        rewardSecondary: { FEAR: 0.7, COURAGE: 0.4, DISCIPLINE: 0.4, READINESS: 0.4 },
    ...
    },
    {
        ...
        costTime: 0.9,
        risk: 0.08,
        rewardSecondary: { FEAR: 0.6, STABILITY: 0.3, CLARITY: 0.3, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.12,
        rewardSecondary: { FEAR: 0.75, SECURITY: 0.4, COMMUNITY: 0.3, HONOR: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.6,
        rewardSecondary: { FEAR: 0.7, CONTROL: 0.3, ORDER: 0.3, READINESS: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { FEAR: 0.6, SPIRIT: 0.2, STABILITY: 0.2, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        risk: 0.12,
        rewardSecondary: { FEAR: 0.75, SECURITY: 0.4, CONTROL: 0.3, READINESS: 0.4 },
    ...
    },
    {
        ...
        costTime: 2.0,
        risk: 0.1,
        rewardSecondary: { FEAR: 0.8, SECURITY: 0.5, READINESS: 0.5, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.4,
        rewardSecondary: { FEAR: 0.7, SECURITY: 0.5, ORDER: 0.2, STABILITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.6,
        rewardSecondary: { FEAR: 0.75, READINESS: 0.6, ORDER: 0.4, RESILIENCE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { FEAR: 0.65, RESILIENCE: 0.4, CLARITY: 0.3, MOOD: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { FEAR: 0.6, CLARITY: 0.4, READINESS: 0.4, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { FEAR: 0.7, KNOWLEDGE: 0.4, COURAGE: 0.3, READINESS: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { FEAR: 0.65, ORDER: 0.5, STABILITY: 0.5, SECURITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { FEAR: 0.6, SPIRIT: 0.3, COMMUNITY: 0.2, RESILIENCE: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.4,
        risk: 0.1,
        rewardSecondary: { FEAR: 0.8, SPIRIT: 0.4, STABILITY: 0.3, SECURITY: 0.3 },
