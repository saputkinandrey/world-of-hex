...
export const FamilyActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.15,
        costTime: 1.0,
        rewardSecondary: { FAMILY: 0.65, BELONGING: 0.4, STABILITY: 0.3, AFFECTION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.25,
        costTime: 2.0,
        rewardSecondary: { FAMILY: 0.8, AFFECTION: 0.5, HEALTH: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 2.0,
        rewardSecondary: { FAMILY: 0.7, MASTERY: 0.4, KNOWLEDGE: 0.4, TRADITION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.3,
        costTime: 2.5,
        rewardSecondary: { FAMILY: 0.85, RESPECT: 0.4, HEALTH: 0.4, TRADITION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.35,
        costTime: 3.0,
        rewardSecondary: { FAMILY: 0.8, STABILITY: 0.6, SECURITY: 0.4, COMFORT: 0.4 },
    ...
    },
    {
        ...
        costTime: 1.5,
        risk: 0.1,
        rewardSecondary: { FAMILY: 0.75, STABILITY: 0.5, COMMUNITY: 0.4, JUSTICE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 3.0,
        rewardSecondary: { FAMILY: 0.7, WEALTH: 0.5, STABILITY: 0.4, TRADITION: 0.4 },
    ...
    },
    {
        ...
        costTime: 1.8,
        risk: 0.15,
        rewardSecondary: { FAMILY: 0.65, COMMUNITY: 0.4, TRADITION: 0.4, STATUS: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 2.5,
        rewardSecondary: { FAMILY: 0.75, BELONGING: 0.5, TRADITION: 0.4, COMMUNITY: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.2,
        rewardSecondary: { FAMILY: 0.7, TRADITION: 0.5, SPIRIT: 0.4, IDENTITY: 0.3 as any },
    ...
    },
    {
        ...
        costEnergy: -0.45,
        costTime: 3.5,
        rewardSecondary: { FAMILY: 0.85, STABILITY: 0.6, COMFORT: 0.5, SECURITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 3.0,
        risk: 0.15,
        rewardSecondary: { FAMILY: 0.95, COMMUNITY: 0.5, JUSTICE: 0.3, TRADITION: 0.3 },
