...
export const CuriosityActions: ActionDefinition[] = [
    {
        ...
        need: NeedTag.CURIOSITY,
        costEnergy: -0.28,
        costTime: 2.4,
        risk: 0.22,
        rewardSatisfaction: 0.85,
        rewardSecondary: { KNOWLEDGE: 0.5, POWER: 0.1, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        risk: 0.18, // яд/аллергия
        rewardSatisfaction: 0.65,
        rewardSecondary: { HEALTH: 0.1, KNOWLEDGE: 0.4 },
    ...
    },
    {
        ...
        rewardSecondary: { WEALTH: 0.25, KNOWLEDGE: 0.4 },
    ...
    },
    {
        ...
        rewardSecondary: { SECURITY: 0.2, KNOWLEDGE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.9,
        risk: 0.08, // дезинформация
        rewardSatisfaction: 0.6,
        rewardSecondary: { KNOWLEDGE: 0.4, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.35,
        costTime: 2.6,
        risk: 0.3, // обвал/ловушки
        rewardSatisfaction: 0.95,
        rewardSecondary: { WEALTH: 0.3, KNOWLEDGE: 0.5, SPIRIT: 0.1 },
    ...
    },
    {
        ...
        rewardSecondary: { MASTERY: 0.4, WEALTH: 0.2, KNOWLEDGE: 0.5 },
    ...
    },
    {
        ...
        risk: 0.15,
        rewardSatisfaction: 0.7,
        rewardSecondary: { CREATIVITY: 0.4, MASTERY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.32,
        costTime: 2.8,
        risk: 0.28, // удушье/обвал
        rewardSatisfaction: 0.9,
        rewardSecondary: { SECURITY: 0.3, POWER: 0.2, KNOWLEDGE: 0.5 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.65,
        rewardSecondary: { KNOWLEDGE: 0.5, TRADITION: 0.1 },
    ...
    },
    {
        ...
        risk: 0.12,
        rewardSatisfaction: 0.8,
        rewardSecondary: { KNOWLEDGE: 0.6, STATUS: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.6,
        rewardSatisfaction: 0.7,
        rewardSecondary: { COMMUNITY: 0.4, POWER: 0.2, KNOWLEDGE: 0.3 },
    ...
    },
    {
        ...
        risk: 0.25,
        rewardSatisfaction: 0.95,
        rewardSecondary: { WEALTH: 0.3, CONTROL: 0.3, KNOWLEDGE: 0.5 },
    ...
    },
    {
        ...
        costTime: 1.0,
        rewardSatisfaction: 0.55,
        rewardSecondary: { STABILITY: 0.3, SECURITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.8,
        rewardSatisfaction: 0.8,
        rewardSecondary: { REPUTATION: 0.4, COMMUNITY: 0.3, KNOWLEDGE: 0.5 },
