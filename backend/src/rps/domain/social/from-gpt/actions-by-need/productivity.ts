...
export const ProductivityActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { PRODUCTIVITY: 0.65, CLARITY: 0.5, ORDER: 0.4, FOCUS: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.6,
        rewardSecondary: { PRODUCTIVITY: 0.6, EFFICIENCY: 0.4, ORDER: 0.3, FOCUS: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { PRODUCTIVITY: 0.65, EFFICIENCY: 0.5, QUALITY: 0.3, ORDER: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { PRODUCTIVITY: 0.7, QUALITY: 0.5, EFFICIENCY: 0.4, CLARITY: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.4,
        rewardSecondary: { PRODUCTIVITY: 0.7, EFFICIENCY: 0.4, QUALITY: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.6,
        rewardSecondary: { PRODUCTIVITY: 0.75, EFFICIENCY: 0.6, ORDER: 0.4, SAFETY: 0.2 as any },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { PRODUCTIVITY: 0.7, EFFICIENCY: 0.5, STABILITY: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.8,
        rewardSecondary: { PRODUCTIVITY: 0.75, MASTERY: 0.4, RESILIENCE: 0.3, EFFICIENCY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        rewardSecondary: { PRODUCTIVITY: 0.7, CLARITY: 0.5, WEALTH: 0.3, ORDER: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.6,
        risk: 0.1,
        rewardSecondary: { PRODUCTIVITY: 0.8, EFFICIENCY: 0.6, STABILITY: 0.4, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { PRODUCTIVITY: 0.6, CLARITY: 0.5, EFFICIENCY: 0.3, QUALITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { PRODUCTIVITY: 0.7, QUALITY: 0.6, EFFICIENCY: 0.3, WASTE: -0.2 as any },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        rewardSecondary: { PRODUCTIVITY: 0.65, EFFICIENCY: 0.4, ORDER: 0.3, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { PRODUCTIVITY: 0.7, STABILITY: 0.5, RESILIENCE: 0.4, EFFICIENCY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { PRODUCTIVITY: 0.65, ORDER: 0.4, CLARITY: 0.4, QUALITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { PRODUCTIVITY: 0.8, FAIRNESS: 0.6, MORALE: 0.5, STABILITY: 0.3 },
