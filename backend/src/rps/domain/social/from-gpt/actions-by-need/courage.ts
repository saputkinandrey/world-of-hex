...
export const CourageActions: ActionDefinition[] = [
    {
        ...
        costTime: 1.6,
        risk: 0.18,
        rewardSecondary: { COURAGE: 0.75, HONOR: 0.4, TRUST: 0.3, READINESS: 0.3 as any },
    ...
    },
    {
        ...
        costTime: 1.4,
        risk: 0.22,
        rewardSecondary: { COURAGE: 0.8, CLARITY: 0.5, RESILIENCE: 0.3, STATUS: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.28,
        rewardSecondary: { COURAGE: 0.85, MORALE: 0.4, HONOR: 0.4, COMMUNITY: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.6,
        risk: 0.3,
        rewardSecondary: { COURAGE: 0.9, HONOR: 0.5, COMMUNITY: 0.4, TRUST: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.3,
        rewardSecondary: { COURAGE: 0.85, HONOR: 0.4, COMMUNITY: 0.3, TRUST: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.22,
        rewardSecondary: { COURAGE: 0.8, INTEGRITY: 0.5, HONOR: 0.4, CLARITY: 0.4 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.2,
        rewardSecondary: { COURAGE: 0.7, RESILIENCE: 0.3, TRUST: 0.2, IDENTITY: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.4,
        risk: 0.32,
        rewardSecondary: { COURAGE: 0.85, COMMUNITY: 0.3, RESILIENCE: 0.4, HONOR: 0.4 },
    ...
    },
    {
        ...
        costTime: 0.9,
        risk: 0.14,
        rewardSecondary: { COURAGE: 0.7, CLARITY: 0.3, COMMUNITY: 0.2, RESILIENCE: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.26,
        rewardSecondary: { COURAGE: 0.85, JUSTICE: 0.4, COMMUNITY: 0.3, HONOR: 0.4 },
    ...
    },
    {
        ...
        costTime: 1.0,
        risk: 0.2,
        rewardSecondary: { COURAGE: 0.75, INTEGRITY: 0.5, JUSTICE: 0.4, TRUST: 0.3 },
        requiresLocation: 'hall|court_square',
