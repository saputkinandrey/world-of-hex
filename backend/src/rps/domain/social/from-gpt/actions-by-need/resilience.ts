...
export const ResilienceActions: ActionDefinition[] = [
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.6,
        rewardSecondary: { RESILIENCE: 0.8, STABILITY: 0.6, SECURITY: 0.3, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.22,
        costTime: 2.0,
        rewardSecondary: { RESILIENCE: 0.8, STABILITY: 0.5, WEALTH: 0.3, HEALTH: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.4,
        risk: 0.08,
        rewardSecondary: { RESILIENCE: 0.8, COMMUNITY: 0.5, TRUST: 0.4, STABILITY: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.22,
        costTime: 1.6,
        rewardSecondary: { RESILIENCE: 0.85, STABILITY: 0.5, PRODUCTIVITY: 0.3, MORALE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.24,
        costTime: 1.8,
        rewardSecondary: { RESILIENCE: 0.8, SECURITY: 0.4, STABILITY: 0.4, HEALTH: 0.1 },
    ...
    },
    {
        ...
        costEnergy: -0.26,
        costTime: 2.0,
        rewardSecondary: { RESILIENCE: 0.85, SECURITY: 0.5, STABILITY: 0.5, WEALTH: 0.2 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.12,
        rewardSecondary: { RESILIENCE: 0.8, HEALTH: 0.6, SECURITY: 0.3, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.16,
        costTime: 1.2,
        rewardSecondary: { RESILIENCE: 0.7, STABILITY: 0.4, PRODUCTIVITY: 0.3, SECURITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.14,
        costTime: 1.2,
        rewardSecondary: { RESILIENCE: 0.75, HEALTH: 0.5, STABILITY: 0.4, SECURITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { RESILIENCE: 0.7, CLARITY: 0.5, STABILITY: 0.4, TRUST: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { RESILIENCE: 0.75, READINESS: 0.5 as any, SECURITY: 0.3, CLARITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 0.9,
        rewardSecondary: { RESILIENCE: 0.7, HEALTH: 0.3, STABILITY: 0.3, MORALE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.0,
        rewardSecondary: { RESILIENCE: 0.8, MORALE: 0.5, COMMUNITY: 0.4, HEALTH: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { RESILIENCE: 0.75, STABILITY: 0.5, WEALTH: 0.4, TRUST: 0.2 },
