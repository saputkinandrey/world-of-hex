...
export const LegacyActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.28,
        costTime: 2.0,
        rewardSecondary: { LEGACY: 0.8, STATUS: 0.3, COMMUNITY: 0.3, TRADITION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.22,
        costTime: 1.8,
        rewardSecondary: { LEGACY: 0.85, COMMUNITY: 0.4, MASTERY: 0.4, STATUS: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.3,
        costTime: 3.0,
        rewardSecondary: { LEGACY: 0.9, FAMILY: 0.5, MASTERY: 0.5, TRADITION: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.1,
        costTime: 1.2,
        rewardSecondary: { LEGACY: 0.6, STATUS: 0.4, IDENTITY: 0.4 as any, TRADITION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.28,
        costTime: 2.2,
        rewardSecondary: { LEGACY: 0.8, FAMILY: 0.5, TRADITION: 0.5, STABILITY: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.45,
        costTime: 4.0,
        rewardSecondary: { LEGACY: 1.0, KNOWLEDGE: 0.7, COMMUNITY: 0.6, STATUS: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.8,
        rewardSecondary: { LEGACY: 0.75, KNOWLEDGE: 0.5, SPIRIT: 0.3, REPUTATION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.25,
        costTime: 2.5,
        rewardSecondary: { LEGACY: 0.85, SPIRIT: 0.5, COMMUNITY: 0.4, HYGIENE: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.18,
        costTime: 1.6,
        rewardSecondary: { LEGACY: 0.7, SPIRIT: 0.5, TRADITION: 0.4, REPUTATION: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.3,
        costTime: 2.2,
        rewardSecondary: { LEGACY: 0.9, STABILITY: 0.5, COMMUNITY: 0.5, WEALTH: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.15,
        rewardSecondary: { LEGACY: 0.7, FAMILY: 0.4, STABILITY: 0.5, JUSTICE: 0.3 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.0,
        rewardSecondary: { LEGACY: 0.6, FAMILY: 0.3, TRADITION: 0.3, CURIOSITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.8,
        rewardSecondary: { LEGACY: 0.9, COMMUNITY: 0.6, TRADITION: 0.6, SPIRIT: 0.4 },
