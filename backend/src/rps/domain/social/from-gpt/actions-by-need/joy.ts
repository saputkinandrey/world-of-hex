...
export const JoyActions: ActionDefinition[] = [
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { JOY: 0.85, MORALE: 0.5, COMMUNITY: 0.4, CULTURE: 0.3 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.06,
        rewardSecondary: { JOY: 0.85, HEALTH: 0.3, COMMUNITY: 0.3, MORALE: 0.3 },
    ...
    },
    {
        ...
        costTime: 0.8,
        risk: 0.08,
        rewardSecondary: { JOY: 0.9, CULTURE: 0.3, COMMUNITY: 0.3, MORALE: 0.4 },
    ...
    },
    {
        ...
        costEnergy: -0.12,
        costTime: 1.2,
        rewardSecondary: { JOY: 0.8, CULTURE: 0.3, PRODUCTIVITY: 0.2, IDENTITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.04,
        costTime: 0.5,
        rewardSecondary: { JOY: 0.75, MORALE: 0.4, SOCIAL: 0.3 as any, RESPECT: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.2,
        costTime: 1.8,
        rewardSecondary: { JOY: 0.9, CULTURE: 0.5, COMMUNITY: 0.4, MORALE: 0.4 },
    ...
    },
    {
        ...
        costTime: 1.4,
        risk: 0.06,
        rewardSecondary: { JOY: 0.8, HEALTH: 0.2, RESILIENCE: 0.2, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.08,
        costTime: 0.8,
        rewardSecondary: { JOY: 0.8, CULTURE: 0.4, STATUS: 0.2, COMMUNITY: 0.2 },
    ...
    },
    {
        ...
        costEnergy: -0.06,
        costTime: 0.7,
        rewardSecondary: { JOY: 0.75, HEALTH: 0.2, RESILIENCE: 0.2, COMMUNITY: 0.1 },
    ...
    },
    {
        ...
        costTime: 1.2,
        risk: 0.06,
        rewardSecondary: { JOY: 0.9, COMMUNITY: 0.4, MORALE: 0.4, CULTURE: 0.2 },
