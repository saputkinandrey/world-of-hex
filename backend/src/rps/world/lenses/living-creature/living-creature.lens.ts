...
export const LivingCreatureLens = new CreatureTemplateLensEntity({
    ...
    morphIdsAdd: ['core.motor_coordination', 'core.perception', 'core.vital.living'],
    actionTagsAdd: [EAT.tag, DRINK.tag, SLEEP.tag],
    needTagsAdd: [NeedTag.FOOD, NeedTag.WATER, NeedTag.REST],
});
